...
const SearchBar: React.FC<SearchBarProps> = ({ 
  ...
  return (
    <div className="relative flex flex-col items-center w-full max-w-md mx-auto mb-4">
      ...
      {/* Results counter - show when searching with reduced padding */}
      {typeof resultsCount !== 'undefined' && typeof totalCount !== 'undefined' && (
        <div className={`text-sm text-center mt-2 mb-2 transition-opacity duration-300 ${debouncedTerm ? 'opacity-100' : 'opacity-0'}`}>
